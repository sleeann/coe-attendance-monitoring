...
<body>
    ...
    ********************-->
    <div id="preloader">
		<div>
			<img src="{{ asset('assets/images/Pangasinan_State_University_logo.png') }}" alt="" width="100px;">
		</div>
    </div>
    <!--*******************
        Preloader end
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div style="display: flex; justify-content:start; align-items:center; flex-direction: row-reverse; gap: 1rem; margin-top: .6rem; padding-left: 1rem;" class="logo_container">
                <span style="font-size: 2em; font-weight: bold; color: white;" class="logo_title">AMS</span>
                <div>
                    <img src="{{ asset('assets/images/Pangasinan_State_University_logo.png') }}" alt="" style="width: 50px;">
                </div>
            </div>
		...
		<div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li>
                        <button style="border: none; background: none;" onclick="redirect('{{ route('parent.home') }}')">
                            <a aria-expanded="false">
                                <div style="display: flex; gap: 1rem; margin-left: .3rem;">
                                    <div>
                                        <i class="fa-solid fa-house"></i>
                                    </div>
                                    <span class="nav-text" style="{{ Request::is('parent/home') || Request::is('/') ? 'color: rgb(248, 185, 64);' : '' }}">Home</span>
                                </div>
						    </a>
                        </button>
					</li>
                    ...
                    <li>
                        <button style="border: none; background: none;" onclick="redirect('{{ route('parent.attendance') }}')">
                            <a aria-expanded="false">
                                <div style="display: flex; gap: 1rem; margin-left: .3rem;">
                                    <div>
                    ...
                    <li>
                        <button style="border: none; background: none;" onclick="redirect('{{ route('parent.announcements') }}')">
                            <a aria-expanded="false">
                                <div style="display: flex; gap: 1rem; margin-left: .3rem;">
                                    <div>
                                        <i class="fa-solid fa-person-chalkboard"></i>
                                    </div>
                                    <span class="nav-text" style="{{ Request::is('parent/announcements') ? 'color: rgb(248, 185, 64);' : '' }}">Announcement</span>
                                </div>
						    </a>
                        </button>
					</li>
                    ...
                    <li>
                        <button style="border: none; background: none;"onclick="redirect('{{ route('parent.grades_score') }}')">
                            <a aria-expanded="false">
                                <div style="display: flex; gap: 1rem; margin-left: .3rem;">
                                    <div>
                                        <i class="fa-solid fa-person-chalkboard"></i>
                                    </div>
                                    <span class="nav-text" style="{{ Request::is('parent/grades&score') ? 'color: rgb(248, 185, 64);' : '' }}">Grades & Scores</span>
                                </div>
						    </a>
                        </button>
					</li>
